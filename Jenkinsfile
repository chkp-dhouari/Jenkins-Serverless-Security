              ...
              agent {
               ...
               steps {
                 withAWS(credentials: 'awscreds', region: 'us-east-1'){
                    ...
                    sh 'aws cloudformation deploy --template-file /var/lib/jenkins/workspace/sam-pipe@2/output.template.yml/output.template.yml --stack-name myapp --capabilities CAPABILITY_IAM'
